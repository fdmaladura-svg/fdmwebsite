// Auto-generated from drizzle/0000_init.sql — do not edit by hand.
// Used by the /api/setup bootstrap endpoint to create the schema on Supabase.
export const SCHEMA_DDL = `CREATE TABLE "admin_users" (
